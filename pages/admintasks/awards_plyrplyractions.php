...
Awards (Player-Player Actions) admin — direct SQL, no EditList dependency.
*/
...
$formAction = htmlspecialchars(
	$g_options['scripturl'] . '?mode=admin&task=awards_plyrplyractions&game=' . urlencode($gamecode) . '&page=' . $currentPage
);
?>
