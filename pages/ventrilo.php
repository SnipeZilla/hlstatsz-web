...
function VentriloDisplayEX1( &$stat, $name, $cid, $bgidx )
{
	...
	{
		$disp_out .= "  <td><span  class=\"hlstats-icon\"><img src=\"".IMAGE_PATH."/ventrilo/".$img.".gif\" alt=\"\" class=\"tsicon\"/></span><span class=\"hlstats-name\">";
		$disp_out .= $name;
		$disp_out .= "</span>\n";
	}
	else
	...
	for ( $i = 0; $i < $clientcount; $i++ )
	{
		...
		$found++;
		$disp_out .= "      <tr>\n";
		$disp_out .= "        <td><span class=\"hlstats-icon\"><img src=\"".IMAGE_PATH."/ventrilo/user.gif\" alt=\"\" /></span>";
