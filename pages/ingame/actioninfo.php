...
if ($db->num_rows($result)) {
    ...
    echo '<div id="actioninfo"><div  class="responsive-table"><table class="maps-table">
        <tr>
            ...
            <th class="'.isSorted('obj_bonus',$sort,$sortorder).'">'.headerUrl('obj_bonus',['obj_sort','obj_sortorder'],'actioninfo').'Skill Bonus Total</a></th>
        </tr>';
    ...
    do {
        echo '<tr>
            ...
            echo '<a href="?mode=statsme&amp;player='.$res['playerId'].'&game='.$game.'" title=""></span><span class="hlstats-name">'.htmlspecialchars($res['playerName']).'</span></a>
            </td>
            <td class="nowrap right">'.$res['obj_count'].'</td>
            <td class="nowrap right">'.$res['obj_bonus'].'</td>
        </tr>';
    ...
    echo Pagination($total, $_GET['obj_page'] ?? 1, 30, 'obj_page', false, 'actioninfo');
...
if ($db->num_rows($result)) {
    ...
    echo '<div  class="responsive-table"><table class="maps-table">
        <tr>
            ...
            <th class="'.isSorted('obj_bonus',$sort,$sortorder).'">'.
    ...
    echo Pagination($total, $_GET['vpage'] ?? 1, $start, 'vpage', false, 'vpage');

    echo '</div>';
  }
} else { echo '<p>No victims found for this action.</p>'; }
?>
<div>
